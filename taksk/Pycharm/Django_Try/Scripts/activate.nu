...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\github\C#\Learn\Python-Learn\Pycharm\Django_Try'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\github\C#\Learn\Python-Learn\Pycharm\Django_Try\Scripts\deactivate.nu'
